...
class SkinToneDetectionSessionHelper:
    ...
    @staticmethod
    def update_session_state(session: models.SkinToneDetectionSession, state: SkinToneSessionState) -> \
    ...
    def create_navigation_and_skin_tones_response(session_id: str, navigation_instruction: NavigationInstruction,
        ...
        if len(skin_tones) > 0:
            response_message[SkinToneDetectionSessionHelper.SKIN_TONES] = [{SkinToneDetectionSessionHelper.RGB: st.rgb,
                                                                            SkinToneDetectionSessionHelper.PERCENT:
